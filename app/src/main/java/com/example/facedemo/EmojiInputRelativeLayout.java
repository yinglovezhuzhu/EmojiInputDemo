 ...
 */
public class EmojiInputRelativeLayout extends RelativeLayout implements
	...
	public EmojiInputRelativeLayout(Context context) {
		super(context);
		this.context = context;
	}

	public EmojiInputRelativeLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
	}

	public EmojiInputRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
